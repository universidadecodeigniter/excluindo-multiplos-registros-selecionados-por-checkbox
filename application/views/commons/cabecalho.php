...
<html lang="pt_BR">
  <head>
    ...
    <meta name="description" content="Excluindo múltiplos registros selecionados por checkbox">
    <meta name="author" content="Universidade CodeIgniter">
    <link rel="icon" href="<?=base_url('assets/images/unici/favicon.png')?>">

    <title>Excluindo múltiplos registros selecionados por checkbox</title>
